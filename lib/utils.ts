...
export const GARMENT_CATEGORIES = [
  ...
  { id: 'shoes', label: 'Chaussures', emoji: '👟', items: ['Sneakers', 'Talons', 'Bottes', 'Mocassins'], available: false },
  { id: 'hats', label: 'Couvre-chef', emoji: '🧢', items: ['Casquette', 'Bonnet', 'Chapeau', 'Bob'], available: false },
  { id: 'jewelry', label: 'Bijoux & Accessoires', emoji: '💍', items: ['Collier', 'Boucles d\'oreilles', 'Bracelet', 'Montre'], available: false },
] as const
